...
export default function ShopPage() {
  const { products, setProducts, loading,fetchAllProducts } = useProducts();
  ...
  if (value === "low-high") {
    await fetchAllProducts("?sort=price_asc");
  } 
  else if (value === "high-low") {
     await fetchAllProducts("?sort=price_desc");
  } 
  else if (value === "new-old") {
     await fetchAllProducts("?sort=newest");
  }
  else if (value === "old-new") {
     await fetchAllProducts("?sort=oldest");
  }
  else {
    return;
  }
